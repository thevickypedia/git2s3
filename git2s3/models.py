...
class EnvConfig(BaseSettings):
    ...
    Notes:
        ...
        - **tar_upload** - Downloads and uploads as tar/zip files to S3.
    ...
    tar_upload: bool = False  # todo: yet to be implemented, use GH API to download zipped version (include branches)
